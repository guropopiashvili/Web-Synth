...
export class AppService {
  presets: Preset[] = [
    ...
    { "name": "New Organ", "startingOctave": 3, "masterParams": { "chorus": 50, "masterVolume": 100, "pan": 50 }, "lfoParams": { "oscillatorType": 0, "mode": 1, "rate": 10, "amplitude": 10 }, "filterParams": { "attack": 0, "decay": 1, "sustain": 100, "release": 1, "cutoff": 80 }, "oscParams": [{ "id": 0, "oscillatorType": 0, "volume": 100, "attack": 0, "decay": 1, "sustain": 100, "release": 1, "coarse": 50, "lfoAmplitude": 0, "isActive": true }, { "id": 1, "oscillatorType": 0, "volume": 70, "attack": 0, "decay": 1, "sustain": 100, "release": 1, "coarse": 75, "lfoAmplitude": 0, "isActive": true }, { "id": 2, "oscillatorType": 1, "volume": 40, "attack": 0, "decay": 1, "sustain": 100, "release": 1, "coarse": 65, "lfoAmplitude": 0, "isActive": true }] },
  ];
