...
import { OscillatorParams, Preset, Sound } from './app-types';
...
export class AppComponent {
  ...
  constructor(private appService: AppService, public helperService: HelperService, private notesService: NotesService, private settingsService: SettingsService) {
